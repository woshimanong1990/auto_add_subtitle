...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_3.clicked.connect(Dialog.selectDirAction)
        self.pushButton.clicked.connect(Dialog.selectFileAction)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "输出文件夹"))
        self.pushButton_3.setText(_translate("Dialog", "选择"))
        self.label.setText(_translate("Dialog", "输入文件"))
